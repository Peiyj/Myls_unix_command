 ...
 * Author: Yingjian Pei
 * Userid: cs30fex
 * Description: Unit test program to test the function timeCompareRev.s
 * Date: Nov 30, 2018
...
/*
 * Unit Test for timeCompareRevRev.s
 *
 * int timeCompareRevRev (const void * p1, const void * p2)*
 * This function will be used with qsort() to sort on the times of two struct 
 * fileInfo in reverse alphabetical order. 
 *
 * Purpose: Tests our timeCompareRevRev implementation by passing a variety of values
 * in as test cases for our function. Tests edge cases like 0:0:0 times, larger
 * times, and others.
 */
void testtimeCompareRevRev() {
...
int main( void ) {
  ...
  fprintf(stderr, "Running tests for timeCompareRev...\n");
  testtimeCompareRevRev();
